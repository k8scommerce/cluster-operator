...
//go:generate mockgen -destination ../internal/controllers/commerce/mocks/similarProducts.go -package=Mocks github.com/localrivet/k8sly/controllers/commerce mode Deployment
